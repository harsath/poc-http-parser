#ifndef POC_TEST_HELPER_H
#define POC_TEST_HELPER_H
#include <stdio.h>
#include <stdlib.h>
...
#define POC_ASSERT_TRUE(expression_result, test_name)						\
	do {											\
...
#define POC_ASSERT_EQ(value_one, value_two, test_name)						\
	do {											\
